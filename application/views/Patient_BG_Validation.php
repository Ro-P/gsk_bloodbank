...
<div class="container-fluid">
    <button class="btn btn-primary back" style="margin-top : 1%"; type="button" ><a href="home"  style="color:white";><i class="fa fa-arrow-left" style="color:white";></i> Back</a></button>
        ...
        <div class="form-row" style="margin-top : 2%";>
            ...
            <div class="form-group col-md-3" style="margin-right: 0px;"><label>Mother Name :</label><input type="text" class="form-control" /></div>
            <div class="form-group col-md-3"><label>Request date :</label><input type="date" class="form-control" id="req_date" name="req_date" /></div>
        ...
        <!-- Mother Details -->
        <div class="row">
            <div class="form-group col-md-12" style="margin-right: 0px;"><label>Mother Details (Neonatal) :</label>
            <!-- Table of Existing Donors -->
			<div>
                <!-- <div class="form-group pull-left"><input type="text" class="search form-control" placeholder="What you looking for?" /></div><span class="counter pull-right"></span> -->
                    <table class="table table-hover table-bordered results">
        ...
        <div class="row">
            <div class="form-group col-md-3"><label>Validate By : </label>
