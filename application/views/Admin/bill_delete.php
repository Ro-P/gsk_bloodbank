...
<div class="container-fluid">
    ...
    <form style="padding-right: 0px;margin-right: 0px;margin-left: 0px;" method="post" action="">
        ...
        <div class="form-row" style="margin-top : 1%";>
            <div class="form-group col-md-3"><label>Patient :</label><input type="text" class="form-control" name="patient1"/></div>
            <div class="form-group col-md-3"><label>Patient Barcode :</label><input type="text" class="form-control" name="patient1"/></div>
            <div class="form-group col-md-3"><label>Date :</label><input type="date" class="form-control" id="from_date" name="from_date" /></div>
        ...
        <div class="form-row" style="margin-top : 1%";>
            <div class="form-group col-md-6"><label>Deactivation Reason : </label>
      			<select class="form-control" id="sel1">
        			<option>+</option>
        			<option>-</option>
      			</select>
            </div>
            <div class="form-group col-md-6 "><label>Remark :</label><input type="text" class="form-control" name="patient1"/></div>
        </div>
