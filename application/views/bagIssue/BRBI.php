...
<div class="container-fluid">
    <button class="btn btn-primary back" style="margin-top : 1%"; type="button" ><a href="home" style="color:white";><i class="fa fa-arrow-left" style="color:white";></i> Back</a></button>
        ...
        <div class="form-row" style="margin-top : 2%";>
            <div class="form-group col-md-6" style="margin-right: 0px;"><label>Patient :</label><input type="text" class="form-control" id="patient"/></div>
            
            <div class="form-group col-md-3"><label>Date :</label><input type="date" class="form-control" id="req_date" name="req_date" /></div>
            <div class="form-group col-md-3"><label>To :</label><input type="date" class="form-control" id="to_date" name="req_date" /></div>
        </div>

        <!-- Patient Details -->
        <div class="row">
          <div class="form-group col-md-12" style="margin-right: 0px;"><label>BBMS Issue Request :</label>
