...
<div class="container-fluid">
    <button class="btn btn-primary back" style="margin-top : 1%"; type="button" ><a href="home" style="color:white";><i class="fa fa-arrow-left" style="color:white";></i> Back</a></button>
        ...
        <div class="form-row" style="margin-top : 2%";>
            ...
            <div class="form-group col-md-3" style="margin-right: 0px;"><label>Patient Barcode :</label><input type="text" class="form-control" /></div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-3" style="margin-right: 0px;"><label>Request Number :</label><input type="text" class="form-control" id="patient"/></div>
            <div class="form-group col-md-3" style="margin-right: 0px;"><label>Bill No. :</label><input type="text" class="form-control" id="patient"/></div>
            <div class="form-group col-md-3"><label>Issue Date :</label><input type="date" class="form-control" id="req_date" name="req_date" /></div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4" style="margin-right: 0px;"><label>Patient Name :</label><input type="text" class="form-control" id="patient"/></div>
            <div class="form-group col-md-4" style="margin-right: 0px;"><label>Hospital Name :</label><input type="text" class="form-control" /></div>
            <div class="form-group col-md-4"><label>Tested BG : </label>
            ...
            <div class="form-group col-md-4" style="margin-right: 0px;"><label>Bag Barcode :</label><input type="text" class="form-control" id="patient"/></div>
            ...
            <div class="form-group col-md-4"><label>Expiry Date :</label><input type="date" class="form-control" id="exp_date" name="req_date" /></div>
            <div class="form-group col-md-4"><label>Bleeding Date :</label><input type="date" class="form-control" id="to_date" name="req_date" /></div>
            <div align="center" class="form-group col-md-4"><label><label><label><label></label></label></label></label>
                <div><button class="btn btn-danger" type="close" style="float:right; margin:1%">Delete</button></div>
                <div><button class="btn btn-success" type="reset" style="float:right; margin:1%">Add</button></div>
            </div>
        </div>
    <!-- </div> -->
          ...
          <!-- Table of Existing Donors -->
            ...
            <!-- <div class="form-group pull-left"><input type="text" class="search form-control" placeholder="What you looking for?" /></div><span class="counter pull-right"></span> -->
              <table class="table table-hover table-bordered results">
                ...
                <tbody>
                <?php $i=1; foreach($one_rec as $row): ?>
                  <tr onclick="enterdetails('<?=$row->patient_name?>','<?=$row->bgrp?>')">
                    <td><?=$i?></td>
                    <td><?=$row->rec_id;?></td>
                    <td><?=$row->patient_name;?></td>
